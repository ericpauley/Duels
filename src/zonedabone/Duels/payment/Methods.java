package zonedabone.Duels.payment;
...
public class Methods {
    ...
    private void _init() {
        this.addMethod("iConomy", new zonedabone.Duels.payment.methods.iCo4());
        this.addMethod("iConomy", new zonedabone.Duels.payment.methods.iCo5());
        this.addMethod("BOSEconomy", new zonedabone.Duels.payment.methods.BOSE());
        this.addMethod("Essentials", new zonedabone.Duels.payment.methods.EE17());
    }
